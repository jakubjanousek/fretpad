          ...
          {MODE_COMPARISON_PRESETS.map((preset) => (
            <button
              ...
              className={cn(
                ...
                mode1Type === preset.mode1Type && mode2Type === preset.mode2Type
      ...
      <div className="space-y-2">
        {mode1Desc && (
          <div className="text-xs">
            ...
            <span className="text-muted-foreground">{mode1Desc.character}</span>
          </div>
        )}
        {mode2Desc && (
          <div className="text-xs">
            ...
            <span className="text-muted-foreground">{mode2Desc.character}</span>
          </div>
        )}
      </div>
