  ...
  return (
    <div className={`${display.variable} relative min-h-screen pb-20`}>
      ...
      <div className="fixed inset-0 -z-10" aria-hidden="true">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-[radial-gradient(ellipse,_rgba(251,146,60,0.06)_0%,_transparent_70%)] dark:bg-[radial-gradient(ellipse,_rgba(251,146,60,0.04)_0%,_transparent_70%)]" />
        <div
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pt-4 space-y-4">
        ...
        >
          <div className="rounded-2xl border border-stone-200/50 dark:border-stone-800/50 bg-white/40 dark:bg-stone-900/30 backdrop-blur-sm p-4 sm:p-5">
            <ProgressionEditor />
          </div>
        </div>
        ...
        <div
          className={cn(
            "rounded-2xl border border-stone-200/50 dark:border-stone-800/50 bg-white/40 dark:bg-stone-900/30 backdrop-blur-sm transition-all duration-300",
